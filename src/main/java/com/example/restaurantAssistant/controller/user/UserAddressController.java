...
import com.example.restaurantAssistant.form.AddressForm;
import com.example.restaurantAssistant.pojo.Address;
import com.example.restaurantAssistant.service.AddressService;
...
public class UserAddressController {
    ...
    //新增收货地址
    @PostMapping("add")
    public Result<Address> addAddress(@Validated AddressForm addressForm,
    ...
    //更新地址
    @PostMapping("update")
    public Result<Address> updateAddress(@Validated AddressForm addressForm,
                                         BindingResult bindingResult,
                                         HttpServletRequest request){
        //校验表单信息
        if (bindingResult.hasErrors()){
