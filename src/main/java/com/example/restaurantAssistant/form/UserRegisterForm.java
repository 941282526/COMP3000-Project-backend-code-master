...
public class UserRegisterForm {
    ...
    @Size( min = 6 ,max = 18,message = "Password length needs to be between 6 and 18")
    private String password;

    @NotNull( message = "Please confirm the password")
    @Size( min = 6 ,max = 18,message = "Duplicate password length needs to be between 6 and 18")
