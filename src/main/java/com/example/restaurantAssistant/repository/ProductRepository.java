...
public interface ProductRepository extends JpaRepository<Product,Integer> {
    ...
    List<Product> findByShopIdAndTypeInAndNameContainsOrderByIdDesc(Integer shopId, List<String> types, String name);
    ...
    List<Product> findByShopIdOrderBySalesDesc(Integer shopId);

    List<Product> findByShopIdAndNameContainsOrderBySalesDesc(Integer shopId, String name);
