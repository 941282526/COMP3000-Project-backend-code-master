...
public interface ProductService {
    ...
    List<ProductCategoryBo> findByShopId(Integer shopId, String keyWord);
     ...
     * @return
     */
    List<ProductBo> findHotByShopId(Integer shopId);

    List<ProductBo> findHotByShopId(Integer shopId, String keyWord);
